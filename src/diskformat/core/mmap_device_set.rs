...
impl BtrfsMmapDeviceSet {
    pub fn open(device_paths: &Vec<PathBuf>) -> Result<BtrfsMmapDeviceSet, String> {
        // open devices
        ...
        Ok(BtrfsMmapDeviceSet { mmaps: mmaps })
    }

    pub fn devices<'a>(&'a self) -> Result<BtrfsDeviceSet<'a>, String> {
        BtrfsDeviceSet::new(
            &self
                .mmaps
                .iter()
